...
<div class="">
      ...
      <div class="text-3xl text-left pt-2">你可以提前掌握任何金融商品的短期走勢 !</div>
      <hr class="mt-2">
    ...
    <div class="foot lg:text-2xl pt-12 pb-12">
    ...
    <div class="box1 text-center">
        ...
        <button class="btn flex bg-secondary hover:bg-blue-700 text-white font-bold py-2 px-12 ml-12 lg:ml-24  rounded mt-8 lg:mt-16">
