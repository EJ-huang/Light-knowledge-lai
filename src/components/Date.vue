        ...
        <div class="container-center2">
            ...
            <div class="flex flex-col items-center text-2xl lg:text-4xl text-center space-y-8 pt-20">
                ...
                <h2 class="text-left font-bold  pb-2">投資人在年末，最該注意什麼？</h2>
                 <p class="flex justify-center bg-secondary w-11/12 lg:w-3/4 text-white p-2">許多人認為產業成長在未來將衰退，2022台股能上2萬點嗎？</p>
                 <p class="justify-center bg-secondary  w-4/5 lg:w-2/4 text-white p-2">2022年度，哪些產業題材是可以關注的重點？</p>
            </div>
            <hr>
            ...
            <div class="flex flex-col items-center text-2xl lg:text-4xl text-center space-y-8 pt-20">
                ...
                <h2 class="text-left font-bold  pb-2">國際通膨與升息對股市的影響及應變方向</h2>
                 <p class="justify-center bg-secondary  w-4/5 lg:w-3/4 text-white p-2">通膨發酵，美國很可能升息，對於股市未來走勢，會產生哪些化學變化？</p>
                 <p class="justify-center bg-secondary  w-4/5 lg:w-2/4 text-white p-2">發生波動時，該做什麼緊急應變？</p>
                 <p class="justify-center bg-secondary  w-4/5 lg:w-2/4 text-white p-2">若空頭來襲，如何把握住這波「海嘯級行情」？</p>
            </div>
            <hr>
            ...
            <div class="flex flex-col items-center text-2xl lg:text-4xl text-center space-y-8 pt-20">
                ...
                <h2 class="text-left font-bold  pb-2">2022台股投資佈局要點與重點操作題材</h2>
                 <p class="justify-center bg-secondary  w-4/5 lg:w-3/4 text-white p-2">許多人認為產業成長在未來將衰退，2022台股能上2萬點嗎？</p>
                 <p class="justify-center bg-secondary  w-4/5 lg:w-2/4 text-white p-2">2022年度，哪些產業題材是可以關注的重點？</p>
            </div>
            <hr>
            ...
            <div class="flex flex-col items-center text-2xl lg:text-4xl text-center space-y-8 pt-20 pb-24">
                ...
                <h2 class="text-left font-bold  pb-2">2022投資交易具體策略與應變措施</h2>
                 <p class="justify-center bg-secondary  w-4/5 lg:w-3/4 text-white p-2">面對通膨壓力、產業低基期的影響，在2022投資上具體的策略是什麼？</p>
                 <p class="justify-center bg-secondary  w-4/5 lg:w-2/4 text-white p-2">在投資交易上，提高投資績效的具體作法有哪些？</p>
            </div>
